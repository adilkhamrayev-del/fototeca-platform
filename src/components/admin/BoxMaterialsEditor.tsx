...
import type { BoxMaterialVariant, BoxMaterialKind } from "@/lib/repo/box-variants";
...
// catalog editors (cover options, cover-material variants) — see the
...
export default function BoxMaterialsEditor({
  barkhat,
  velur,
  upsertAction,
  deleteAction,
}: {
  barkhat: BoxMaterialVariant[];
  velur: BoxMaterialVariant[];
...
function VariantRow({
  ...
  return (
    <form action={formAction} className="flex flex-wrap items-center gap-2">
      ...
      <PhotoUploadField imageUrl={imageUrl} onChange={setImageUrl} endpoint="/api/admin/box-media" alt="Превью варианта" />
      <input
        name="name"
